...
export const CardComponent = () => {
  ...
  function getDate(str, version) {
    ...
    if (version === 'desktop') {
      ...
      } ${date.getDate()}, ${date.getFullYear()} at ${hours}:${minutes} ${ampm}`;
      return strTime;
    }
    if (version === 'mobile') {
  ...
  function goBack() {
    if (location.state && location.state.var !== 'photo-requests') {
      navigate(`../authentications/${location.state.var === 'progress' ? 'in-progress' : 'completed'}`, {
              ...
              <div className="card-container">
                <div className="card__info-wrapper">
                  <div className="card__info__header">
                    <button className="card__info__header-arrow" onClick={goBack}>
