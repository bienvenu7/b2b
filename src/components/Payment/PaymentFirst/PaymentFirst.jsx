    ...
    <>
      ...
      <div className="payment_first-container">
        ...
        <div className="payment_first__order-wrapper">
            ...
            {totalPackage !== null &&
              ...
              totalPackage.userTariffPackages.map(
                (e, index) =>
                  e.productType !== '' &&
                  e.answerTime !== '' && (
                    <div key={index} className="payment_first__order-packages-elem">
          ...
          <div className="payment_first__order__error-label">Payment unsuccessful! Please try again.</div>
          <div className="payment_first__order__button-wrapper">
            {/* eslint-disable-next-line jsx-a11y/click-events-have-key-events,
            jsx-a11y/no-static-element-interactions */}
            <div className={buttonState ? 'button' : 'button disabled'} onClick={() => buttonState && postInvoice()}>
              Pay now
            </div>
          </div>
