    ...
    <>
      ...
      <div className="payment_first-container">
        <div className="payment_first__bundle-wrapper">
          <PaymentHeader />
          <div className="payment_first__bundle__billing-header">
            Billing information
          </div>
          <div className="payment_first__bundle__billing-wrapper">
            <div className="payment_first__bundle__billing-elem">
              <div className="payment_first__bundle__billing-label">
                Business name
              </div>
              <div className="payment_first__bundle__billing-value">
                Luxury store
              </div>
              <div className="payment_first__bundle__billing-button">
                Change
              </div>
            </div>
            <div className="payment_first__bundle__billing-elem">
          ...
          <div className="payment_first__bundle__vars-wrapper">
            ...
            <div className="payment_first__bundle__vars-h2">
        ...
        <div className="payment_first__order-wrapper">
          ...
          <div className="payment_first__order-packages-wrapper">
            {totalPackage !== null &&
              totalPackage.userTariffPackages &&
              totalPackage.userTariffPackages.map(
                (e, index) =>
                  e.productType !== "" &&
                  e.answerTime !== "" && (
                    <div
                      key={index}
                      className="payment_first__order-packages-elem"
                    >
                      <div className="photo">img</div>
                      <div className="label">{e.productType.publicName}</div>
                      <div className="hours">{e.answerTime} hours</div>
                      <div className="cost">
                        {e.volume} * {costs[index] / 100}
                      </div>
                      <div className="total">
                        $ {e.volume * (costs[index] / 100)}
                      </div>
          ...
          <div className="payment_first__order__promocode-wrapper">
            <input
              className="payment_first__order__promocode-elem"
              placeholder="add promocode"
            />
          </div>
          <div className="payment_first__order__subtotal-wrapper">
            <label className="payment_first__order__subtotal-label">
              Subtotal
            </label>
            <div className="payment_first__order__subtotal-count" id="count">
              ${total / 100}
            </div>
          </div>
          ...
          <div className="payment_first__order__button-wrapper">
            <div
              className={buttonState ? "button" : "button disabled"}
              onClick={() => buttonState && postInvoice()}
            >
              Pay now
            </div>
          </div>
          <div className="payment_first__order__error-wrapper">
            <div className="payment_first__order__error-h1">
              Payment unsuccessful
            </div>
            <div className="payment_first__order__error-h2">
              Please try again!
            </div>
          </div>
        </div>
