      ...
      <div className="auth__content-promo">
        <div className="auth__content-promo-elem">
          ...
          <div className="promo-h2">
            Access the most advanced authentication expertise at the lowest
            possible cost.
          </div>
        </div>
        <div className="auth__content-promo-elem">
          ...
          <div className="promo-h2">
            Automated authentication process, live dashboard and customisable
        ...
        <div className="auth__content-promo-elem">
          ...
          <div className="promo-h2">
            Priority support for your team to ensure the smoothest process
            execution.
          </div>
        </div>
      </div>
      <div className="auth__content-form">
        <div className="auth__content-form-headers">
          ...
          <div className="message-h1">
            Welcome to the LegitGrails Business Platform!
          </div>
        ...
        <div className="auth__form">
          <form className="auth__form__signup" onSubmit={formik.handleSubmit}>
            ...
            <input
              ...
              onClick={() =>
                postErrors && postErrors.signup && dispatch(setErrors(null))
              }
            />
            {formik.touched.email && formik.errors.email ? (
              <div className="auth__form-errorMessage">
