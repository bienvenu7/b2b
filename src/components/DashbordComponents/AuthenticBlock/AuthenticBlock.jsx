  ...
  return (
    <BlockComponentLayout>
      <div className='authentic-block__container'>
        <div className='authentic-block__left-block'>
          ...
          <button className='authentic-block__button'>Learn how to improve the score</button>
        </div>
        <div className='authentic-block__right-block'>
          ...
          <button className='authentic-block__button'>See all verified items</button>
        </div>
      </div>
    </BlockComponentLayout>
  )
